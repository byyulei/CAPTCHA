...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "runs/train-cls/exp/weights/best.pt", help="model.pt path(s)")
    parser.add_argument("--imgsz", "--img", "--img-size", nargs="+", type=int, default=[128, 128], help="image (h, w)") # 最小128
    ...
    parser.add_argument("--opset", type=int, default=13, help="ONNX: opset version") # 跟预测的要对应
