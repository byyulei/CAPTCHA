...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "runs/train/exp6/weights/best.pt", help="model.pt path(s)")
    parser.add_argument("--imgsz", "--img", "--img-size", nargs="+", type=int, default=[320, 320], help="image (h, w)") # 最小128
